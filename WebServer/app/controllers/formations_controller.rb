class FormationsController < ApplicationController
  ...
  def index
    ...
    @titre = "Field of formation"
    @description = "You can get all the courses which belong to the following formation:"
  end

  # GET /formations/1
  # GET /formations/1.json
  def show
    @titre = 'Courses for '+@formation.name+' formation.'
    @description = 'Here, you have the list of all the courses that are possible to do in the '+@formation.name+' formation.'
  end
